...
/*   Updated: 2022/06/05 02:29:18 by vcordeir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_free_scene(void *param)
{
	...
	scene = (t_scene *)param;
	if (scene->file_infos)
		ft_free_2d_array_char(scene->file_infos, scene->file_number_of_lines);
	if (scene->map)
		ft_free_2d_array_char(scene->map, scene->map_height);
